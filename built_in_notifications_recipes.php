...
return [
    'invoice' => [
        ...
        'params' => new NotificationParameterCollection([
            ...
            new NotificationParameter(
                'invoice_currency',
                lkn_hn_lang('invoice_currency'),
                fn (): string => getInvoiceCurrencyCode($this->whmcsHookParams['invoiceid'])
            ),
            new NotificationParameter(
                'client_id',
            ...
            new NotificationParameter(
                'client_last_name',
                lkn_hn_lang('client_last_name'),
                fn () => getClientLastNameByClientId($this->clientId)
            ),
            new NotificationParameter(
                'client_email',
    ...
    'ticket' => [
        ...
        'params' => new NotificationParameterCollection([
            ...
            new NotificationParameter(
                ...
                fn () => empty($this->clientId)
                    ? ''
                    : getClientLastNameByClientId($this->clientId)
            ),
            new NotificationParameter(
                'client_full_name',
                lkn_hn_lang('client_full_name'),

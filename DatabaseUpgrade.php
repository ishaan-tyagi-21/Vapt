...
final class DatabaseUpgrade
{
    ...
    public static function v320(): void
    {
        ...
        $newIdentifierHash         = bin2hex(random_bytes(16));
    ...
    public static function v440(): void
    {
        try {
            $pdo = Capsule::connection()->getPdo();
            ...
            lkn_hn_log('Database 4.4.0 success', null, ['table' => 'mod_lkn_hook_notification_custom']);
        } catch (Throwable $th) {
            lkn_hn_log('Database 4.4.0 upgrade failed', null, $th->__toString());
        }
    }
}
